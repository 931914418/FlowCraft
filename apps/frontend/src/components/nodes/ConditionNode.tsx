...
const ConditionNode = memo(function ConditionNode(props: NodeProps) {
  ...
  return (
    ...
    >
      <div
        className={cn(
          'relative min-w-[180px] overflow-hidden rounded-lg border-2 border-amber-400 bg-amber-50 shadow-sm transition-all duration-300',
      ...
      >
        ...
        <div className="flex">
          <div className="w-1 self-stretch rounded-l-lg bg-amber-500" />
